const CACHE = 'quickboard-v82';
const ASSETS = ['./', './index.html', './styles.css?v=82', './app.js?v=82', './firebase-config.js?v=82', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
