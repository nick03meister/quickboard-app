const CACHE = 'quickboard-v27';
const ASSETS = ['./', './index.html', './styles.css?v=27', './app.js?v=27', './firebase-config.js?v=27', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
