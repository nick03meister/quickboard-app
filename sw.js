const CACHE = 'quickboard-v58';
const ASSETS = ['./', './index.html', './styles.css?v=58', './app.js?v=58', './firebase-config.js?v=58', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
