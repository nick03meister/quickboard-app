const CACHE = 'quickboard-v52';
const ASSETS = ['./', './index.html', './styles.css?v=52', './app.js?v=52', './firebase-config.js?v=52', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
