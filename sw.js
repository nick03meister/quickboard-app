const CACHE = 'quickboard-v79';
const ASSETS = ['./', './index.html', './styles.css?v=79', './app.js?v=79', './firebase-config.js?v=79', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
