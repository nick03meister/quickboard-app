const CACHE = 'quickboard-v50';
const ASSETS = ['./', './index.html', './styles.css?v=50', './app.js?v=50', './firebase-config.js?v=50', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
