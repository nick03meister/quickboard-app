const CACHE = 'quickboard-v44';
const ASSETS = ['./', './index.html', './styles.css?v=44', './app.js?v=44', './firebase-config.js?v=44', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
