const CACHE = 'quickboard-v69';
const ASSETS = ['./', './index.html', './styles.css?v=69', './app.js?v=69', './firebase-config.js?v=69', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
