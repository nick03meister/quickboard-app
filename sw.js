const CACHE = 'quickboard-v73';
const ASSETS = ['./', './index.html', './styles.css?v=73', './app.js?v=73', './firebase-config.js?v=73', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
