const CACHE = 'quickboard-v35';
const ASSETS = ['./', './index.html', './styles.css?v=35', './app.js?v=35', './firebase-config.js?v=35', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
