const CACHE = 'quickboard-v66';
const ASSETS = ['./', './index.html', './styles.css?v=66', './app.js?v=66', './firebase-config.js?v=66', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
