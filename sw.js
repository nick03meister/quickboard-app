const CACHE = 'quickboard-v65';
const ASSETS = ['./', './index.html', './styles.css?v=65', './app.js?v=65', './firebase-config.js?v=65', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
