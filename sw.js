const CACHE = 'quickboard-v34';
const ASSETS = ['./', './index.html', './styles.css?v=34', './app.js?v=34', './firebase-config.js?v=34', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
