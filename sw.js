const CACHE = 'quickboard-v83';
const ASSETS = ['./', './index.html', './styles.css?v=83', './app.js?v=83', './firebase-config.js?v=83', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
