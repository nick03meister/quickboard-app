const CACHE = 'quickboard-v78';
const ASSETS = ['./', './index.html', './styles.css?v=78', './app.js?v=78', './firebase-config.js?v=78', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
