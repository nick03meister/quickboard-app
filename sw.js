const CACHE = 'quickboard-v41';
const ASSETS = ['./', './index.html', './styles.css?v=41', './app.js?v=41', './firebase-config.js?v=41', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
