const CACHE = 'quickboard-v67';
const ASSETS = ['./', './index.html', './styles.css?v=67', './app.js?v=67', './firebase-config.js?v=67', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
