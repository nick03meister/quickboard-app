const CACHE = 'quickboard-v81';
const ASSETS = ['./', './index.html', './styles.css?v=81', './app.js?v=81', './firebase-config.js?v=81', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
