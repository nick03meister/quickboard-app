const CACHE = 'quickboard-v31';
const ASSETS = ['./', './index.html', './styles.css?v=31', './app.js?v=31', './firebase-config.js?v=31', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
