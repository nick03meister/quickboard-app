const CACHE = 'quickboard-v38';
const ASSETS = ['./', './index.html', './styles.css?v=38', './app.js?v=38', './firebase-config.js?v=38', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
