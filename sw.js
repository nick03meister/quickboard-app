const CACHE = 'quickboard-v80';
const ASSETS = ['./', './index.html', './styles.css?v=80', './app.js?v=80', './firebase-config.js?v=80', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
