const CACHE = 'quickboard-v72';
const ASSETS = ['./', './index.html', './styles.css?v=72', './app.js?v=72', './firebase-config.js?v=72', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
