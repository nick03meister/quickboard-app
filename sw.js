const CACHE = 'quickboard-v64';
const ASSETS = ['./', './index.html', './styles.css?v=64', './app.js?v=64', './firebase-config.js?v=64', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
