const CACHE = 'quickboard-v51';
const ASSETS = ['./', './index.html', './styles.css?v=51', './app.js?v=51', './firebase-config.js?v=51', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
