const CACHE = 'quickboard-v29';
const ASSETS = ['./', './index.html', './styles.css?v=29', './app.js?v=29', './firebase-config.js?v=29', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
