const CACHE = 'quickboard-v63';
const ASSETS = ['./', './index.html', './styles.css?v=63', './app.js?v=63', './firebase-config.js?v=63', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
