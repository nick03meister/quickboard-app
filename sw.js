const CACHE = 'quickboard-v28';
const ASSETS = ['./', './index.html', './styles.css?v=28', './app.js?v=28', './firebase-config.js?v=28', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
