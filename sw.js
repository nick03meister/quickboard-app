const CACHE = 'quickboard-v33';
const ASSETS = ['./', './index.html', './styles.css?v=33', './app.js?v=33', './firebase-config.js?v=33', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
