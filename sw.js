const CACHE = 'quickboard-v36';
const ASSETS = ['./', './index.html', './styles.css?v=36', './app.js?v=36', './firebase-config.js?v=36', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
