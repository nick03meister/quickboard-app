const CACHE = 'quickboard-v54';
const ASSETS = ['./', './index.html', './styles.css?v=54', './app.js?v=54', './firebase-config.js?v=54', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
