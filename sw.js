const CACHE = 'quickboard-v42';
const ASSETS = ['./', './index.html', './styles.css?v=42', './app.js?v=42', './firebase-config.js?v=42', './manutd-crest.webp', './icon-192.png', './icon-512.png', './icon-maskable.png', './icon-180.png', './manifest.webmanifest'];
